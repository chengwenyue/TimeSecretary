...
public class AffairAddActivity extends BaseActivity implements AndroidBug5497Workaround.OnKeyboardListener,
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.affair_save_bt:{
                ...
                Affair.addAffair(getContentResolver(),getBuilder().create());


                Intent intent  = Affair.createIntent(AffairAddActivity.this,MainActivity.class,getBuilder().getAffair().mId);
                setResult(MainActivity.RESULT_OK,intent);
                AffairAddActivity.this.finish();
                return;
            }
