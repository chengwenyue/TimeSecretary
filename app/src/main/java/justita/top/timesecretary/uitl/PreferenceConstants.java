...
public class PreferenceConstants {
	...
	public final static String MAX_ALARM_ID = "max_alarm_id";

	public final static String LAST_START_DATE = "last_start_date";

	public final static String IS_TIME = "isTime";
	public final static String IS_HIDE = "isHide";
